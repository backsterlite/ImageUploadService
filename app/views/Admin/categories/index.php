                        ...
                        <div class="box-body">
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="/category/<?php echo $category['id'];  ?>" class="btn btn-info">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="/admin/category/<?php echo $category['id']; ?>/edit" class="btn btn-warning">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="/admin/category/<?php echo $category['id']; ?>/delete" class="btn btn-danger" onclick="return confirm('Вы уверены?');">
