            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="content">
                        <?= $photo['description'];?>
                        <br>
                        <time datetime="2016-1-1" class="is-size-6 is-pulled-left">Добавлено: <?= date('d/m/Y', strtotime($photo['date']));?></time>
        ...
        <div class="column is-one-quarter">
            <div class="card">
                ...
                <div class="card-content">
                    <div class="media">
                        <div class="media-left">
                            <p class="title is-5"><a href="/gallery/<?= $image['category_id']?>"><?= getCategory($image['category_id'])['title'];?></a></p>
                        </div>
                        <div class="media-right">
                            <p  class="is-size-7">Размер: <?= $image['dimensions'];?></p>
                            <time datetime="2016-1-1" class="is-size-7">Добавлено: <?= date('d/m/Y', strtotime($image['date']));?></time>
                        </div>
                    </div>
                </div>
            </div>
