...
<section class="hero is-warning">
    <div class="hero-body">
        <div class="container">
            ...
            <h2 class="subtitle">
                Заполните форму и обновите фото.
            </h2>
        </div>
    </div>
</section>
        ...
        <div class="column is-quarter auth-form">
            ...
            <form action="/photos/<?= $photo['id'];?>/update" method="post" enctype="multipart/form-data">
                <div class="field">
                    ...
                    <div class="control">
                        <input class="input" name="title" type="text" value="<?= $photo['title']?>">
                    </div>
                </div>
                        ...
                        <div class="select">
                            <select name="category_id">
                                <?php foreach (getAllCategories() as $category):  ?>
                                    <option <?php if($photo['category_id'] == $category['id']) :?>selected <?php endif; ?>
                ...
                <div class="field is-grouped">
                    <div class="control">
                        <button class="button is-success is-large" type="submit">Обновить</button>
                    </div>
                </div>
            </form>
        </div>
